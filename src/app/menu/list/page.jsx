...
export default function MenuListPage() {
    ...
    return (
        <div className="container px-4 py-8 mx-auto">
            <h1 className="mb-8 text-3xl font-bold text-center">Menu Kami</h1>
            ...
            {filteredItems.length === 0 && (
                <p className="mt-8 text-center text-gray-500">Tidak ada item menu yang ditemukan. Silakan coba pencarian atau kategori lain.</p>
            )}
        </div>
    )
}