        ...
        <header className="sticky top-0 z-10 shadow-lg bg-gradient-to-r from-gray-800 to-gray-900">
          <div className="container flex items-center justify-between py-4 mx-auto">
            {pathOtherThanHome.includes(pathname) ? (
              ...
              <nav className="hidden space-x-1 md:flex md:gap-3">
                <motion.h1
                  onClick={() => router.push("/")}
            ...
            <div className="flex items-center space-x-4">
              {user && (
                <>
                  <Button
                    size="icon"
                    className="relative bg-transparent hover:text-white hover:bg-gray-700"
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        className="relative text-gray-300 rounded-full size-8 hover:text-white hover:bg-gray-700"
                      >
              ...
              {!user && (
                <Button
                  ...
                  className="text-gray-900 bg-white transition-colors duration-200 hover:opacity-95 font-bold"
                >
                  Login
                </Button>
              )}
